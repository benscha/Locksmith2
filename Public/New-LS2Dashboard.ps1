function New-LS2Dashboard {
    ...
    $standardColumns = @(
        ...
        @{N = 'TamemyCertHardening'; E = {
                if ($null -ne $_.TamemyCertHardening) {
                    $_.TamemyCertHardening
                }
                else {
                    'N/A'
                }
        ...
        @{N = 'TamemyCertHardeningXmlName'; E = {
                if ($_.TamemyCertHardening -eq $true -and $_.TamemyCertHardeningXmlName) {
                    $_.TamemyCertHardeningXmlName
                }
                else {
                    'N/A'
                }
        ...
        @{N = 'TamemyCertHardeningSummary'; E = { if ($_.TamemyCertHardeningSummary) { $_.TamemyCertHardeningSummary } else { 'N/A' } } }
